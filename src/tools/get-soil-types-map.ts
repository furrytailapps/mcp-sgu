...
export const getSoilTypesMapInputSchema = {
  bbox: z
    .object({
...
export const getSoilTypesMapHandler = withErrorHandling(async (args: GetSoilTypesMapInput) => {
  ...
  // Get the map URLs
  const mapResponse = sguClient.getSoilTypesMapUrl(bbox, {
    width: args.width,
    height: args.height,
    format: args.format,
  });

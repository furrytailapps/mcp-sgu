...
export const getSoilDepthMapInputSchema = {
  bbox: z
    .object({
...
export const getSoilDepthMapHandler = withErrorHandling(async (args: GetSoilDepthMapInput) => {
  ...
  // Get the map URLs
  const mapResponse = sguClient.getSoilDepthMapUrl(bbox, {
    width: args.width,
    height: args.height,
    format: args.format,
  });
